...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    temp_1,cache_1=affine_relu_forward(X,self.params['theta1'],self.params['theta1_0'])
    scores,cache_2=affine_forward(temp_1,self.params['theta2'],self.params['theta2_0'])
    ...
    reg_1=0.5*self.reg*(np.sum(self.params['theta1']**2)+np.sum(self.params['theta2']**2))
    loss=loss+reg_1
    
    d_temp,grads['theta2'],grads['theta2_0']=affine_backward(d_loss,cache_2)
    _,grads['theta1'],grads['theta1_0']=affine_relu_backward(d_temp,cache_1)
    grads['theta1']=grads['theta1']+self.reg*self.params['theta1']
    grads['theta2']=grads['theta2']+self.reg*self.params['theta2']
...
class FullyConnectedNet(object):
 ...
 #   scores,caches[self.num_layers-2]=affine_forward(temp_i,self.params['theta'+str(self.num_layers-1)],self.params['theta'+str(self.num_layers-1)+'_0'])
...
#    d_temp,grads['theta'+str(self.num_layers-1)],grads['theta'+str(self.num_layers-1)+'_0']=affine_backward(d_loss,caches[self.num_layers-2])
...
#      grads['theta'+str(i)]=grads['theta'+str(i)]+self.reg*self.params['theta'+str(i)]
    ...
    loss,d_loss=softmax_loss(scores, y)
    loss=loss+0.5*self.reg*(np.sum(self.params['theta'+str(self.num_layers-1)]**2))
    d_temp,grads['theta'+str(self.num_layers-1)],grads['theta'+str(self.num_layers-1)+'_0']=affine_backward(d_loss,caches[self.num_layers-2]['cache'])
    for i in range(self.num_layers-2,0,-1):
      loss=loss+0.5*self.reg*(np.sum(self.params['theta'+str(i)]**2))
